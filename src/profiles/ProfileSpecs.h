...
const std::array hooks_game_ss_2_v2_2
{
    ...
    HookSpec{0x980D1, reinterpret_cast<uintptr_t>(&GameDllHooks::prepareGlobalUi_ver<V>), 0xE8},
    ...
    HookSpec{0xC9594, reinterpret_cast<uintptr_t>(&GameDllHooks::updateEntitiesUnderMouse_ver<V>), 0xE8},
    HookSpec{0xC9682, reinterpret_cast<uintptr_t>(&GameDllHooks::updateEntitiesUnderMouse_ver<V>), 0xE8},
    HookSpec{0xC95AA, reinterpret_cast<uintptr_t>(&GameDllHooks::updateBattlefieldHover_ver<V>), 0xE8},
    HookSpec{0xC95D7, reinterpret_cast<uintptr_t>(&GameDllHooks::updateBattlefieldHover_ver<V>), 0xE8},
    HookSpec{0xC963C, reinterpret_cast<uintptr_t>(&GameDllHooks::updateBattlefieldHover_ver<V>), 0xE8},
    HookSpec{0xC9698, reinterpret_cast<uintptr_t>(&GameDllHooks::updateBattlefieldHover_ver<V>), 0xE8},
    HookSpec{0xC96C1, reinterpret_cast<uintptr_t>(&GameDllHooks::updateBattlefieldHover_ver<V>), 0xE8},
    HookSpec{0x9EFCA, reinterpret_cast<uintptr_t>(&GameDllHooks::calculateCursorTypeAtZoom_ver<V>), 0xE8},
    //HookSpec{0x6AEA0, reinterpret_cast<uintptr_t>(&GameDllHooks::sub_1006AEA0)},
    //HookSpec{0x6B1C0, reinterpret_cast<uintptr_t>(&GameDllHooks::sub_1006B1C0)},
    //HookSpec{0x6B2C0, reinterpret_cast<uintptr_t>(&GameDllHooks::sub_1006B2C0)},
    //HookSpec{0x6D940, reinterpret_cast<uintptr_t>(&GameDllHooks::sub_1006D940)},
