...
// This is just a list of existing games and mods.
// This list is neither complete nor fully usable. For all mods see Readme
enum class GameVersion
{
    ...
    SS_BLACK_SEA,       // Противостояние: Принуждение к миру (2008)
