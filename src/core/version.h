...
#define SS_BLACK_SEA_V1_2_VERSION_MAJOR 1
#define SS_BLACK_SEA_V1_2_VERSION_MINOR 2
#define SS_BLACK_SEA_V1_2_VERSION_STR STR(SS_BLACK_SEA_V1_2_VERSION_MAJOR) "." STR(SS_BLACK_SEA_V1_2_VERSION_MINOR)
#define SS_BLACK_SEA_V1_2_GAME_STR "Confrontation: Black Sea v" SS_BLACK_SEA_V1_2_VERSION_STR
